...
public class ErrorConstants {
    ...
    public static final String usernameInvalid = "Username is Invalid, Please Try Again.";
    public static final String userInactive = "User status is either inactive, Blocked or suspended";
    public static final String incorrectPassword = "Incorrect Password! Please try again.";
    ...
    public static final String forgotPasswordEntryNotFound = "Forgot password trigger entry is not found, Try again.";
